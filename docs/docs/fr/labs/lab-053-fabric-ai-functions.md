...
- **[Lab 051](lab-051-fabric-rti-agents.md)** — Fabric IQ — Agents d'intelligence en temps réel
- **[Lab 052](lab-052-fabric-conversational-agent.md)** — Fabric IQ — Agent conversationnel de données
