...
| **OutdoorGear Sales Agent** *(scénario capstone de ce dépôt)* | Interroge les données de produits et de commandes, génère des graphiques, interprète les tendances de ventes |
