# 📊 Parcours Ingénieur / Analyste de Données
...
Vous travaillez avec les données — analytics, BI, pipelines ETL — et souhaitez ajouter des agents IA à vos flux de travail de données pour l'analyse conversationnelle, les insights automatisés et le traitement intelligent des données.

---

## Séquence Recommandée

### Phase 1 — Fondamentaux de l'IA pour les Professionnels des Données
...
**Total : 12 labs · ~11 heures · Des fondamentaux des données à l'analyse propulsée par l'IA**
