...
- **[Lab 051](lab-051-fabric-rti-agents.md)** — Fabric IQ — Agentes de Inteligência em Tempo Real
- **[Lab 052](lab-052-fabric-conversational-agent.md)** — Fabric IQ — Agente Conversacional de Dados