...
!!! info "Tipo de prática"
    Este lab analisa pontuações de recuperação pré-gravadas. Ele ensina avaliação de RAG multimodal e trade-offs de design sem chamar um modelo de visão ao vivo.
