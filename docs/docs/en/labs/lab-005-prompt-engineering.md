...
### Real example: OutdoorGear Sales Agent (from this repo's capstone scenario)
...
Run the challenge file you downloaded from the [📦 Supporting Files](#-supporting-files) section above:
