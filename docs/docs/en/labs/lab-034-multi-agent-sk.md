...
<div class="lab-meta">
  ...
  <span><strong>💰 Cost:</strong> <span class="level-badge cost-azure-free">Azure subscription</span></span>
</div>
...
>
> **Overview:** Build an orchestrator agent that spawns specialist worker agents using SK's multi-agent framework.
