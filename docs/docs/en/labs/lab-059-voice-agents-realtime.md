...
!!! info "Practice type"
    This lab analyzes a pre-recorded voice-session dataset. It teaches Realtime API architecture and operational metrics, but it does not connect to a live WebRTC or GPT Realtime endpoint.
