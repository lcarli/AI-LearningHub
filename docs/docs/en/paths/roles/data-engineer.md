...
You work with data — analytics, BI, ETL pipelines — and want to add AI agents to your data workflows for conversational analytics, automated insights, and intelligent data processing.

---

## Recommended Sequence

### Phase 1 — AI Fundamentals for Data People
...
### Phase 2 — Work IQ & Copilot Analytics
...
**Total: 12 labs · ~11 hours · From data fundamentals to AI-powered analytics**
